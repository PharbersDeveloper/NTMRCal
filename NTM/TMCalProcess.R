...
TMCalProcess <- function(
    ...
    projectid,
    periodid) {
	output_dir <- paste0("hdfs://192.168.100.14:8020/tmtest0831/jobs/", jobid, "/output/")
	print(jobid)
    ...
    # write.df(cal_data, "hdfs://192.168.100.14:8020//test/TMTest/inputParquet/TMInputParquet0815/output/abcde")
    # write.parquet(cal_data, "hdfs://192.168.100.14:8020//test/TMTest/inputParquet/TMInputParquet0815/output/abcde-parquet")
    #write.parquet(cal_data, paste("hdfs://192.168.100.14:8020//test/TMTest/output", jobid, "TMResult", sep = "/"))
    ...
    #write.parquet(competitor_data, paste("hdfs://192.168.100.14:8020//test/TMTest/output", jobid, "TMCompetitor", sep = "/"))
    ...
    #write.parquet(assessment, paste("hdfs://192.168.100.14:8020//test/TMTest/output", jobid, "Assessment", sep = "/"))
...
#测试程序
# TMCalProcess(
#     cal_data_path = "hdfs://192.168.100.14:8020//test/TMTest/inputParquet/TMInputParquet0815/cal_data",
#     weight_path = "hdfs://192.168.100.14:8020//test/TMTest/inputParquet/TMInputParquet0815/weightages",
#     manage_path = "hdfs://192.168.100.14:8020//test/TMTest/inputParquet/TMInputParquet0815/manager",
#     curves_path = "hdfs://192.168.100.14:8020//test/TMTest/inputParquet/TMInputParquet0815/curves-n",
#     competitor_path = "hdfs://192.168.100.14:8020//test/TMTest/inputParquet/TMInputParquet0815/competitor",
#     standard_time_path = "hdfs://192.168.100.14:8020//test/TMTest/inputParquet/TMInputParquet0815/standard_time",
#     level_data_path = "hdfs://192.168.100.14:8020//test/TMTest/inputParquet/TMInputParquet0815/level_data",
